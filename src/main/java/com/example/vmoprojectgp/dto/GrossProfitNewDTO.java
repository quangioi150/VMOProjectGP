...
public class GrossProfitNewDTO {
    private double percent;
    ZonedDateTime effectiveDate;
    ZonedDateTime expiredDate;
    List<SegmentsDTO> segments;

    public GrossProfitNewDTO() {
    }

    public GrossProfitNewDTO(double percent, ZonedDateTime effectiveDate, ZonedDateTime expiredDate, List<SegmentsDTO> segments) {
